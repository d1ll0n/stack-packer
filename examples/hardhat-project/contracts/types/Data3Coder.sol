...
function decode(Data3 encoded) internal pure returns (
	uint256 myEnum,
	uint256 a,
	int256 b,
	int256 c,
	...
	assembly {
		myEnum := shr(Data3_myEnum_bitsAfter, encoded)
		a := and(MaxUint16, shr(Data3_a_bitsAfter, encoded))
		b := signextend(0x01, shr(Data3_b_bitsAfter, encoded))
		c := signextend(0x03, shr(Data3_c_bitsAfter, encoded))
		d := and(MaxUint1, shr(Data3_d_bitsAfter, encoded))
		x := and(MaxUint1, shr(Data3_x_bitsAfter, encoded))
	}
}
...
function getMyEnum(Data3 encoded) internal pure returns (uint256 myEnum) {
	assembly {
		myEnum := shr(Data3_myEnum_bitsAfter, encoded)
	}
}
...
function getA(Data3 encoded) internal pure returns (uint256 a) {
	assembly {
		a := and(MaxUint16, shr(Data3_a_bitsAfter, encoded))
	}
}
...
function getB(Data3 encoded) internal pure returns (int256 b) {
	assembly {
		b := signextend(0x01, shr(Data3_b_bitsAfter, encoded))
	}
}
...
function getC(Data3 encoded) internal pure returns (int256 c) {
	assembly {
		c := signextend(0x03, shr(Data3_c_bitsAfter, encoded))
	}
}
...
function getD(Data3 encoded) internal pure returns (bool d) {
	assembly {
		d := and(MaxUint1, shr(Data3_d_bitsAfter, encoded))
	}
}
...
function getX(Data3 encoded) internal pure returns (bool x) {
	assembly {
		x := and(MaxUint1, shr(Data3_x_bitsAfter, encoded))
	}
}
