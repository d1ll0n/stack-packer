...
Data2 constant DefaultData2 = Data2.wrap(0);
...
//////////////////////////////////////////////////////////////*/
    ...
    )
  {
    assembly {
      ...
      b := signextend(
        0x01,
        shr(Data2_b_bitsAfter, encoded)
      )
      c := signextend(
        0x03,
        shr(Data2_c_bitsAfter, encoded)
      )
      d := and(
        MaxUint1,
        shr(Data2_d_bitsAfter, encoded)
      )
    }
  }
...
//////////////////////////////////////////////////////////////*/
  ...
  function setA(Data2 old, uint256 a)
    internal
    pure
...
//////////////////////////////////////////////////////////////*/
  ...
  function setB(Data2 old, int256 b)
    internal
    pure
    returns (Data2 updated)
  {
...
//////////////////////////////////////////////////////////////*/
  ...
  function setD(Data2 old, bool d)
    internal
    pure
    returns (Data2 updated)
  {
  ...
  /*//////////////////////////////////////////////////////////////
                    Data2 comparison methods
//////////////////////////////////////////////////////////////*/

  function equals(Data2 a, Data2 b)
    internal
    pure
  ...
  function isNull(Data2 a)
    internal
    pure
    returns (bool _isNull)
  {
    _isNull = equals(a, DefaultData2);
  }
}
