...
contract ExternalData2Coder {
  ...
  {
    (a, b, c, d) = Data2Coder.decode(_data2);
  }
  ...
  function setAbc(
    ...
    (_data2) = Data2Coder.setAbc(_data2, a, b, c);
  }
  ...
  function setCba(
    ...
    (_data2) = Data2Coder.setCba(_data2, c, b, a);
  }
  ...
  function setA(uint256 a) external {
    (_data2) = Data2Coder.setA(_data2, a);
  }
  ...
  function setB(int256 b) external {
    (_data2) = Data2Coder.setB(_data2, b);
  }
  ...
  function setD(bool d) external {
    (_data2) = Data2Coder.setD(_data2, d);
  }
}
